...
class CheckerBoardTestAdvanced(CheckerBoard):
    ...
    def __init__(self): # constructor
        ...
        # title
        self.textPlay.loadTextLine('CheckerBoard Advanced Test. Powered by Funtrench', \
          self.textKeys[0])
        # instructions
        ...
        self.textPlay.loadTextLine('Press B/W to turn board to your side', \
            self.textKeys[2])
        self.textPlay.loadTextLine('Use the LMB to select and move a piece', self.textKeys[3])
