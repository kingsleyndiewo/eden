...
class CheckersMarkIITest(CheckersMarkII):
    ...
    def __init__(self):  # constructor
        CheckersMarkII.__init__(
            self, versusAI=True, customPRC={"fullscreen": False}
        ...
        self.textPlay.loadTextLine(
            "CheckersMarkII Test. Powered by Funtrench", self.textKeys[0]
        )
        # instructions
        ...
        # manual text
        t_n = (
            self.gameMVC.mvcStructure["tier_resource"]["text"]
