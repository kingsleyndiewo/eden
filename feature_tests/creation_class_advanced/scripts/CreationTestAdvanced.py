...
# File name: CreationTestAdvanced.py
...
# Class.
# Class definition for the CreationTestAdvanced class
# --------------------------------------------------
class CreationTestAdvanced(Creation):
    ...
    def __init__(self):  # constructor
        ...
        self.loadGeometry("cube", "cube", (0.25, 0.25, 0.25), (0, 0, 3))
        ...
        # title
        t_z = "Creation Test Advanced. Powered by Funtrench"
        ...
        self.accept("s", self.screenCapture, ["../CreationAdvanced_"])
        self.accept(
