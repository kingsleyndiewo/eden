...
class GenesisTest(Genesis):
    ...
    def __init__(self):  # constructor
        ...
        self.textPlay.loadTextLine(
            "Genesis Test. Powered by Funtrench", self.textKeys[0]
        )
        # instructions
        ...
        self.ladyEvePosInterval1 = self.ladyEve.baseActor.posInterval(
            7, Point3(0, -15, 0), startPos=Point3(0, 10, 0)
        )
        self.ladyEvePosInterval2 = self.ladyEve.baseActor.posInterval(
            7, Point3(0, 10, 0), startPos=Point3(0, -15, 0)
        )
        ...
        self.accept(
            "i", self.textPlay.displayText, ["Game", 30, (0.20, 0, 0.95), False]
        )
