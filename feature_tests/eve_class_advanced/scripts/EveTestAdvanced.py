...
# Desc: Advanced Test Project for the Eve Class
# File name: EveTestAdvanced.py
# Developed by: Project Eden Development Team
# Date: 29/07/2008
# Place: Nairobi, Kenya
# |------------------------------------------------|
# | (C)2018 Funtrench Limited.            |
# |------------------------------------------------|
import sys
...
# Class definition for the EveTestAdvanced class
# --------------------------------------------------
class EveTestAdvanced(Eve):
    ...
    def __init__(self):  # constructor
        ...
        self.textPlay.loadTextLine(
            "Eve Test Advanced. Powered by Funtrench", self.textKeys[0]
        )
        # instructions
