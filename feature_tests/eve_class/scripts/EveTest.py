...
# Desc: Test Project for the Eve Class
# File name: EveTest.py
...
# Class definition for the EveTest class
# --------------------------------------------------
class EveTest(Eve):
    ...
    def __init__(self):  # constructor
        ...
        # title
        self.textPlay.loadTextLine("Eve Test. Powered by Funtrench", self.textKeys[0])
        # instructions
        ...
        self.accept("s", self.screenCapture, ["../Eve_"])
        self.accept(
        ...
        self.accept("actor-switch", self.jukeBox["switch"].play, [])
