...
class CheckerBoardTestAgent(CheckerBoard):
    ...
    def __init__(self): # constructor
        CheckerBoard.__init__(self, ignorePicker = True, customPRC={'fullscreen':False}) # ancestral constructor
        t_f = [('arial.egg', 'Arial')]
        ...
        # title
        self.textPlay.loadTextLine('CheckerBoard Agent Test. Powered by Funtrench', \
          self.textKeys[0])
        # instructions
