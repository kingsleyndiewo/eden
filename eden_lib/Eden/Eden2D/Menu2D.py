...
class Menu2D:
    ...
    def loadMenu(self, menuXML, callBackList):
        ...
        if t_bi == "None":
            ...
            self.menuList[t_n]["imagePosition"] = (
                self.menuXPU.Parser["XML_Values"]["FrameImage_Values"]["posX"],
                self.menuXPU.Parser["XML_Values"]["FrameImage_Values"]["posY"],
                self.menuXPU.Parser["XML_Values"]["FrameImage_Values"]["posZ"],
            )
            self.menuList[t_n]["imageScale"] = (
                self.menuXPU.Parser["XML_Values"]["FrameImage_Values"]["scaleX"],
                self.menuXPU.Parser["XML_Values"]["FrameImage_Values"]["scaleY"],
                self.menuXPU.Parser["XML_Values"]["FrameImage_Values"]["scaleZ"],
            )
        # the frame
        t_pos = (
            self.menuXPU.Parser["XML_Values"]["Frame_Values"]["posX"],
            self.menuXPU.Parser["XML_Values"]["Frame_Values"]["posY"],
            self.menuXPU.Parser["XML_Values"]["Frame_Values"]["posZ"],
        )
        t_siz = (
            self.menuXPU.Parser["XML_Values"]["Frame_Values"]["sizeL"],
        ...
        t_col = (
            self.menuXPU.Parser["XML_Values"]["Frame_Values"]["colR"],
        ...
        t_bdm = (
            self.menuXPU.Parser["XML_Values"]["Frame_Values"]["borderW"],
            self.menuXPU.Parser["XML_Values"]["Frame_Values"]["borderH"],
        )
        self.menuList[t_n]["menuFrame"] = DirectFrame(
            frameSize=t_siz,
            pos=t_pos,
            frameColor=t_col,
            image=self.menuList[t_n]["backImage"],
            image_pos=self.menuList[t_n]["imagePosition"],
    ...
    def loadLabel(self, labelName, menuName):
        ...
        t_ct = (
            self.menuXPU.Parser["XML_Values"][t_k]["colR"],
        ...
        t_cs = (
            self.menuXPU.Parser["XML_Values"][t_k]["scolR"],
        ...
        # create label
        self.menuList[menuName]["labels"][labelName] = DirectLabel(
            text=t_tx,
            frameColor=t_cf,
            text_fg=t_ct,
            scale=t_sc,
        ...
        # set on frame
        self.menuList[menuName]["labels"][labelName].reparentTo(
            self.menuList[menuName]["menuFrame"]
        )
        self.menuList[menuName]["labels"][labelName].setPos(
    ...
    def loadButton(self, buttonName, menuName):
        ...
        # create the button
        self.menuList[menuName]["buttons"][buttonName] = DirectButton(
            text=t_tx,
            command=self.callBacks[t_cfi][0],
            extraArgs=self.callBacks[t_cfi][1],
            text_shadow=t_cs,
            scale=t_sc,
            frameColor=t_cf,
            text_fg=t_ct,
        ...
        # set on the frame
        self.menuList[menuName]["buttons"][buttonName].reparentTo(
            self.menuList[menuName]["menuFrame"]
        )
        self.menuList[menuName]["buttons"][buttonName].setPos(
            t_pos[0], t_pos[1], t_pos[2]
        )
    ...
    def loadRadioButton(self, buttonName, menuName):
        ...
        # set on the frame
        self.menuList[menuName]["radioButtons"][buttonName].reparentTo(
            self.menuList[menuName]["menuFrame"]
        )
        self.menuList[menuName]["radioButtons"][buttonName].setPos(
            t_pos[0], t_pos[1], t_pos[2]
        )
    ...
    def loadSlider(self, sliderName, menuName):
        ...
        t_cft = (
            self.menuXPU.Parser["XML_Values"][t_k]["tcolR"],
        ...
        # load range
        t_rge = (
            self.menuXPU.Parser["XML_Values"][t_k]["rangeMinimum"],
        ...
        # massive border)
        t_bw = (
            self.menuXPU.Parser["XML_Values"][t_k]["borderWidth"],
        ...
        self.menuList[menuName]["sliders"][sliderName] = DirectSlider(
            ...
            command=self.callBacks[t_cfi][0],
            extraArgs=self.callBacks[t_cfi][1],
            thumb_text_shadow=t_cs,
            thumb_text_scale=t_sc,
            frameColor=t_cf,
            thumb_text_fg=t_ct,
            thumb_text_font=t_fn,
            value=t_iv,
            range=t_rge,
            pageSize=t_sv,
            orientation=t_ox,
            thumb_frameColor=t_cft,
            thumb_borderWidth=t_bw,
            thumb_text_align=t_alg,
        )
        # set on the frame
        self.menuList[menuName]["sliders"][sliderName].reparentTo(
            self.menuList[menuName]["menuFrame"]
        )
        self.menuList[menuName]["sliders"][sliderName].setPos(
            t_pos[0], t_pos[1], t_pos[2]
        )
    ...
    def loadOptionMenu(self, optionName, menuName):
        ...
        t_ch = (
            self.menuXPU.Parser["XML_Values"][t_k]["hcolR"],
        ...
        self.menuList[menuName]["optionMenus"][optionName] = DirectOptionMenu(
            text=t_tx,
            scale=t_sc,
            items=t_il,
            initialitem=t_ii,
        ...
        # parent to the frame
        self.menuList[menuName]["optionMenus"][optionName].reparentTo(
            self.menuList[menuName]["menuFrame"]
        )
        self.menuList[menuName]["optionMenus"][optionName].setPos(
            t_pos[0], t_pos[1], t_pos[2]
        )
