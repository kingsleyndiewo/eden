...
# utility lists
alphaModeList = (
    BaseParticleRenderer.PRALPHANONE,
    BaseParticleRenderer.PRALPHAOUT,
    BaseParticleRenderer.PRALPHAIN,
    BaseParticleRenderer.PRALPHAUSER,
)
blendModeList = (
    PointParticleRenderer.PPONECOLOR,
    PointParticleRenderer.PPBLENDLIFE,
...
forceList = (LinearVectorForce, AngularVectorForce, LinearJitterForce, LinearNoiseForce)
